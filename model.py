...
class NewModel(LabelStudioMLBase):
    ...
    def clear_queue(self,queue_name='celery'):
    ...
    def fit(self, event, data, **kwargs):
       ...
       #======================================implement the train in the rq worker which shoul run in the background==========================================================================
        ...
        result = trainyolov8.delay(custom_yaml_path="my_ml_backyolotest/custum.yaml")
    
        #append the job
        jobs_back.append(result.id)
        ...
        print(f'Number of tasks in the queue:{self.get_queue_length()}')
